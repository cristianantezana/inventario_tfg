...
<div id="page_pdf">
	<table id="factura_head">
		<tr>
          ...
          <p>No. Factura: <strong>{{$pedido->n_factura}}</strong></p>
	...
	<table id="factura_cliente">
		<tr>
			<td class="info_cliente">
              ...
              <td><label>Nit:</label><p>{{$pedido->proveedor->persona->nit}}</p></td>
            @endforeach 
							
              @foreach ($pedidos as $pedido)
              <td><label>Teléfono:</label> <p>{{$pedido->proveedor->persona->celular}}</p></td>
            ...
            @endforeach 
              ...
              <td><label>Nombre:</label><p>{{$pedido->proveedor->persona->nombre.' '.$pedido->proveedor->persona->apellido}}</p></td>
            @endforeach 
            @foreach ($pedidos as $pedido)
            <td><label>Dirección:</label> <p>{{$pedido->proveedor->persona->direccion}}</p></td>
	...
	<table id="factura_detalle">
      ...
      <tbody id="detalle_productos">
        ...
        <tr>
          <td class="textcenter">{{$detalle->cantidad_compra}}</td>
          <td class="text-center">{{$detalle->catalogo->producto->nombre_producto}}</td>
          <td class="textright">{{$detalle->precio_compra}}</td>
