                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group col-6"> 
                                                                    ...
                                                                    <input type="number" value="{{$proveedor->persona->celular}}" class="form-control" id="celular" name="celular" onkeypress="return valideKey(event);"  required>
                                                                </div>
                                                                <div class="form-group col-6"> 
                                                                    <label for="telefono">Telefono</label>
                                                                    <input type="number" value="{{$proveedor->persona->celular_2}}" class="form-control" id="telefono" name="telefono" onkeypress="return valideKey(event);" >
                                                                </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="form-group col-6"> 
