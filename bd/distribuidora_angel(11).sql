...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-01-2023 a las 05:41:33
...
(4, 8, 1, 100, '95.00', '2022-12-31', '8.00', 1, '2022-12-22 20:08:00', '2022-12-22 20:08:00'),
(5, 1, 1, 102, '70.00', '2022-12-31', '8.00', 1, '2022-12-22 22:16:01', '2022-12-22 22:16:01'),
(6, 2, 1, 1003, '75.00', '2022-12-16', '40.00', 1, '2022-12-22 22:29:06', '2022-12-22 22:29:06'),
(7, 7, 2, 1005, '78.00', '2022-12-17', '40.00', 1, '2022-12-22 22:29:34', '2022-12-22 22:29:34');
...
(7, 7, 2, 'NADA', '2023-01-12 00:00:00', 1, '2023-01-03 05:51:49', '2023-01-03 05:51:49'),
(8, 7, 222, 'EW', '2023-01-03 00:00:00', 1, '2023-01-03 05:53:18', '2023-01-03 05:53:18'),
(9, 4, 10, 'lll', '2023-01-18 00:00:00', 1, '2023-01-03 06:46:44', '2023-01-03 06:46:44');
...
(5, 7, 5, '9.00', '40.00', '360.00', 1, '2023-01-03 05:51:49', '2023-01-03 05:51:49'),
(6, 8, 7, '50.00', '10.00', '500.00', 1, '2023-01-03 05:53:18', '2023-01-03 05:53:18'),
(7, 8, 6, '50.00', '10.00', '500.00', 1, '2023-01-03 05:53:18', '2023-01-03 05:53:18'),
(8, 8, 5, '50.00', '10.00', '500.00', 1, '2023-01-03 05:53:18', '2023-01-03 05:53:18'),
(9, 8, 4, '50.00', '10.00', '500.00', 1, '2023-01-03 05:53:18', '2023-01-03 05:53:18'),
(10, 9, 7, '5.00', '4.00', '20.00', 1, '2023-01-03 06:46:44', '2023-01-03 06:46:44'),
(11, 9, 4, '5.00', '4.00', '20.00', 1, '2023-01-03 06:46:44', '2023-01-03 06:46:44');
...
CREATE TRIGGER `tr_updStockCompra` AFTER INSERT ON `detalle_compra` FOR EACH ROW BEGIN    	
		UPDATE catalogo SET stock = stock + NEW.cantidad_compra
        WHERE catalogo.cod_catalogo = NEW.cod_catalogo_detalle;
END
$$
DELIMITER ;
...
CREATE TABLE `detalle_pedido` (
  `cod_detalle_pedido` int(11) NOT NULL,
  `cod_pedido_detalle` int(11) NOT NULL,
  `cod_catalogo_detalle` int(11) NOT NULL,
  `cantidad_detalle` decimal(10,0) NOT NULL,
  `precio_detalle` decimal(10,0) NOT NULL,
  `estado` int(11) NOT NULL DEFAULT 1,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `detalle_pedido` (`cod_detalle_pedido`, `cod_pedido_detalle`, `cod_catalogo_detalle`, `cantidad_detalle`, `precio_detalle`, `estado`, `created_at`, `updated_at`) VALUES
(1, 5, 6, '30', '40', 1, '2022-12-30 21:42:00', '2022-12-30 21:42:00'),
(2, 5, 7, '30', '40', 1, '2022-12-30 21:42:00', '2022-12-30 21:42:00'),
(3, 6, 6, '20', '40', 1, '2022-12-30 21:44:32', '2022-12-30 21:44:32'),
(4, 7, 7, '2', '40', 1, '2023-01-01 01:16:26', '2023-01-01 01:16:26'),
(5, 8, 6, '10', '40', 1, '2023-01-01 01:17:37', '2023-01-01 01:17:37'),
(6, 9, 5, '2', '8', 1, '2023-01-01 01:18:35', '2023-01-01 01:18:35'),
(7, 10, 5, '10', '8', 1, '2023-01-01 01:19:20', '2023-01-01 01:19:20'),
(8, 11, 6, '20', '40', 1, '2023-01-01 03:34:04', '2023-01-01 03:34:04'),
(9, 11, 7, '20', '40', 1, '2023-01-01 03:34:04', '2023-01-01 03:34:04'),
(10, 11, 4, '5', '8', 1, '2023-01-01 03:34:04', '2023-01-01 03:34:04'),
(11, 11, 5, '1', '8', 1, '2023-01-01 03:34:04', '2023-01-01 03:34:04'),
(12, 12, 4, '30', '8', 1, '2023-01-01 03:37:04', '2023-01-01 03:37:04'),
(13, 12, 5, '1', '8', 1, '2023-01-01 03:37:04', '2023-01-01 03:37:04'),
(14, 13, 5, '5', '8', 1, '2023-01-01 03:46:57', '2023-01-01 03:46:57'),
(15, 13, 7, '5', '40', 1, '2023-01-01 03:46:57', '2023-01-01 03:46:57'),
(16, 13, 6, '5', '40', 1, '2023-01-01 03:46:57', '2023-01-01 03:46:57'),
(17, 13, 4, '5', '8', 1, '2023-01-01 03:46:57', '2023-01-01 03:46:57');

--
-- Disparadores `detalle_pedido`
--
DELIMITER $$
CREATE TRIGGER `tr_updStockPedido` AFTER INSERT ON `detalle_pedido` FOR EACH ROW BEGIN
	UPDATE catalogo SET stock = stock - NEW.cantidad_detalle WHERE catalogo.cod_catalogo = NEW.cod_catalogo_detalle;
END
$$
DELIMITER ;
...
CREATE TABLE `pedido` (
  ...
  `total_pedido` decimal(11,0) NOT NULL,
  `estado` tinyint(4) NOT NULL DEFAULT 1,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `pedido` (`cod_pedido`, `cod_cliente_ped`, `fecha_pedido`, `n_pedido`, `total_pedido`, `estado`, `created_at`, `updated_at`) VALUES
(2, 2, '0000-00-00', 1, '0', 1, '2022-11-06 21:39:37', '2022-11-06 21:39:37'),
(4, 9, '2022-12-30', 2, '400', 1, '2022-12-30 21:33:07', '2022-12-30 21:33:07'),
(5, 9, '2022-12-21', 3, '2400', 1, '2022-12-30 21:42:00', '2022-12-30 21:42:00'),
(6, 8, '2022-12-14', 4, '800', 1, '2022-12-30 21:44:32', '2022-12-30 21:44:32'),
(7, 6, '2022-12-14', 5, '80', 1, '2023-01-01 01:16:26', '2023-01-01 01:16:26'),
(8, 9, '2022-12-23', 6, '400', 1, '2023-01-01 01:17:37', '2023-01-01 01:17:37'),
(9, 9, '2022-12-30', 7, '16', 1, '2023-01-01 01:18:35', '2023-01-01 01:18:35'),
(10, 9, '2022-12-23', 8, '80', 1, '2023-01-01 01:19:20', '2023-01-01 01:19:20'),
(11, 4, '2023-01-02', 9, '1648', 1, '2023-01-01 03:34:04', '2023-01-01 03:34:04'),
(12, 9, '2023-01-04', 10, '248', 1, '2023-01-01 03:37:04', '2023-01-01 03:37:04'),
(13, 8, '2022-12-07', 11, '480', 1, '2023-01-01 03:46:57', '2023-01-01 03:46:57');
...
ALTER TABLE `detalle_pedido`
  ADD PRIMARY KEY (`cod_detalle_pedido`);
...
--
ALTER TABLE `detalle_compra`
  MODIFY `cod_detalle_compra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `detalle_pedido`
--
ALTER TABLE `detalle_pedido`
  MODIFY `cod_detalle_pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
